...
public class DeftPlayerCamera : MonoBehaviour
{
  ...
  void LateUpdate()
  {
    ...
    angleH += player_controller.controller_look_direction.x * horizontalAimingSpeed * Time.deltaTime;
    angleV += player_controller.controller_look_direction.y * verticalAimingSpeed * Time.deltaTime;
